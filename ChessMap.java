...
public class ChessMap extends JFrame {
	...
	private JMenuItem[] menuitem1 = { new JMenuItem("重新开始"),
			new JMenuItem("悔棋"), new JMenuItem("退出") };
	private JMenuItem[] menuitem2 = { new JMenuItem("禁手选择"),
			new JMenuItem("人机博弈"), new JMenuItem("人人对弈") };
	...
	public void init() {
		...
		whitechess = nePw ImageIcon(getClass().getResource("whitechess.gif"));
	...
	class Menuitemclicked implements ActionListener // 菜单消息处理
	{
		public void actionPerformed(ActionEvent e) {
			...
			if (actionCommand.equals("Rollback")) { // 悔棋
				...
				int sel = JOptionPane
						.showOptionDialog(null, "你的选择：", "禁手选择",
				...
				int sel = JOptionPane
						.showOptionDialog(null, "你的选择：", "先手选择",
								JOptionPane.DEFAULT_OPTION,
								JOptionPane.QUESTION_MESSAGE, null, options,
								options[0]);
				if (sel == 1) { // 机器先手
